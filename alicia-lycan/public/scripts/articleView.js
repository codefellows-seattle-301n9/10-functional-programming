...
(function (module) {
  ...
  articleView.initAdminPage = () => {
    let statsTemplate = $('#stats').html();
    let statsTemplateInit = Handlebars.compile(statsTemplate);
    ...
    app.Article.numWordsByAuthor().forEach(stat => $('.author-stats').append(statsTemplateInit(stat)));
